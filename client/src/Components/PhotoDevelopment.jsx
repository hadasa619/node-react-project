...
function PhotoDevelopment() {
    ...
    const fetchData = async () => {
        ...
        data = data.filter((prod) => {
            return prod.prodName == "photoDevelopment"
        })
        setId(data[0]._id)
    ...
    const addToCart = async () => {
        ...
        const { data } = await Axios.post(`http://localhost:1200/api/products/byName`, { prodName: "photoDevelopment" })
        const obj = {
            prodId: data[0]._id,
            qty: value3,
...
export default PhotoDevelopment